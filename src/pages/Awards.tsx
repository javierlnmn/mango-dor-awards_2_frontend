  ...
  const awards = [
    {
      ...
      description: "The highest honor for exceptional flavor, texture, and overall quality.",
      category: "Grand Prize"
    },
    {
      title: "Best New Variety",
      description: "Recognizing innovative cultivation and unique genetic characteristics.",
      category: "Innovation"
    },
    {
    ...
    },
    {
      ...
      description: "The favorite mango as voted by our community of enthusiasts.",
      category: "Community"
    },
    {
      title: "Artisan Producer",
      description: "Celebrating small-scale growers with exceptional craftsmanship.",
      category: "Craftsmanship"
    },
    {
      title: "Export Excellence",
      description: "Outstanding quality in international trade and distribution.",
      category: "Trade"
    }
  ];
    ...
    <main className='min-h-screen overflow-hidden bg-black relative py-20 pt-32'>
      ...
      <div className='max-w-6xl mx-auto px-8 relative z-50'>
        <div className='text-center mb-16'>
          <h1 className='text-5xl font-bold text-white mb-4'>Award Categories</h1>
          <p className='text-xl text-gray-300'>
            Celebrating excellence across multiple dimensions of mango cultivation
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {awards.map((award, index) => (
            <Card key={index}>
              <div className='mb-3'>
                <span className='text-sm text-orange-400 font-medium'>{award.category}</span>
              </div>
              <h3 className='text-white text-xl font-bold mb-3'>{award.title}</h3>
