...
export default function Home() {
  return (
    <main className='flex flex-col gap-4 items-center justify-center overflow-hidden bg-black relative pt-20'>
      <Spotlight
      ...
      <div className='h-screen w-screen flex items-center justify-center'>
        <div className='flex-1 flex items-center justify-center'>
          <img src={logo} alt="Mango D'Or Awards" className='max-w-[500px] w-full h-auto animate-glow' />
        </div>
      </div>
