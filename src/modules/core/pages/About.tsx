      ...
      <div className='max-w-4xl mx-auto px-8 text-center relative z-50'>
        ...
        <div className='space-y-6 text-gray-300'>
          <p className='text-lg leading-relaxed'>
            Welcome to the Mango D'Or Awards, the most prestigious recognition in the world of 
            mangoes and tropical fruit excellence. Our annual celebration brings together 
            growers, connoisseurs, and enthusiasts from around the globe.
          </p>
          <p className='text-lg leading-relaxed'>
            Founded with a passion for recognizing the finest varieties and cultivation 
            techniques, we honor those who dedicate their lives to perfecting the art 
            of mango production.
          </p>
          <p className='text-lg leading-relaxed'>
            Join us as we celebrate the golden fruit that has captured hearts and 
